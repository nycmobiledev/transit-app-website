...
This privacy policy governs your use of the software application Where's My Train (“Application”) for mobile devices that was created by the NYC Mobile .NET Developers Group. The Application displays arrival times of NYC MTA subway trains. The Application allows users to select their favorite subway stations and to view the upcoming trains at the selected station. The train schedule information is a combination of real-time and static schedules, both provided by the MTA through their open data feeds. 
...
* if NYC Mobile .NET Developers Group is involved in a merger, acquisition, or sale of all or a portion of its assets, you will be notified via email and/or a prominent notice on our Web site of any change in ownership or uses of this information, as well as any choices you may have regarding this information.
